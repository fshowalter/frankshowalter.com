...
function UpdateListItem({
  ...
  return (
    <li className="relative flex w-[48%] max-w-[248px] flex-col items-center text-subtle has-[a:hover]:bg-hover has-[a:hover]:text-inverse has-[a:hover]:shadow-hover min-[600px]:w-[30.66666667%] tablet:w-[31.33333333%] desktop:w-[14.16666667%]">
      <a
